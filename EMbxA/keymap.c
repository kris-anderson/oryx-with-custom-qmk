...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    ALL_T(KC_ESCAPE),MT(MOD_LCTL, KC_A),MT(MOD_LALT, KC_S),MT(MOD_LGUI, KC_D),MT(MOD_LSFT, KC_F),KC_G,                                           ALL_T(KC_H),    MT(MOD_RSFT, KC_J),MT(MOD_RGUI, KC_K),MT(MOD_RALT, KC_L),MT(MOD_RCTL, KC_SCLN),ALL_T(KC_QUOTE),
    MEH_T(KC_GRAVE),LT(4,KC_Z),     LT(3,KC_X),     LT(2,KC_C),     LT(1,KC_V),     KC_B,                                           MEH_T(KC_N),    LT(1,KC_M),     KC_COMMA,       KC_DOT,         KC_SLASH,       MEH_T(KC_MINUS),
